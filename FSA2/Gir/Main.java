...
public class Main {
    public static void main(String[] args) {
        ...
        String[] consonants = {"b", "b", "c", "c", "d", "d", "d", "d", "f", "f", "g", "g", "g", "h", "h", "j", "k", "l", "l", "l", "l", "m", "m", "n", "n", "n", "n", "n", "n", "p", "p", "q", "r", "r", "r", "r", "r", "r", "s", "s", "s", "s", "t", "t", "t", "t", "t", "t", "v", "v", "w", "w", "x", "y", "y", "z"};
        String[] consonantPairs = {"bl", "br", "ch", "cl", "dr", "fl", "gl", "gr", "ng", "ph", "pl", "pr", "qu", "sc", "sh", "sk", "sm", "sn", "sp", "st", "sw", "th", "ph", "th", "tw", "wh"};
        //"qu" is a weird pair because Q is rarely without U, but it's not a Consonant Pair by definition
